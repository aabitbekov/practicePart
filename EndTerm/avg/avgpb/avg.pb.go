...
func (x *AvgRequest) GetNum1() int64 {
	if x != nil {
		return x.Num1
	}
	return 0
...
var file_avg_avgpb_avg_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x76, 0x67, 0x22, 0x32, 0x0a, 0x0a, 0x41, 0x76,
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x75, 0x6d, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x75,
	0x6d, 0x31, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x6e, 0x75, 0x6d, 0x31, 0x22, 0x25,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x45, 0x0a, 0x0a, 0x41, 0x76, 0x67, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4f, 0x66, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x0f, 0x2e, 0x61, 0x76, 0x67, 0x2e, 0x41, 0x76, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x61, 0x76, 0x67, 0x2e, 0x41, 0x76, 0x67,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x0b, 0x5a, 0x09,
	0x61, 0x76, 0x67, 0x2f, 0x61, 0x76, 0x67, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_avg_avgpb_avg_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_avg_avgpb_avg_proto_depIdxs = []int32{
	0, // 0: avg.AvgService.StreamOfNumber:input_type -> avg.AvgRequest
	1, // 1: avg.AvgService.StreamOfNumber:output_type -> avg.AvgResponse
...
func (c *avgServiceClient) StreamOfNumber(ctx context.Context, opts ...grpc.CallOption) (AvgService_StreamOfNumberClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AvgService_serviceDesc.Streams[0], "/avg.AvgService/StreamOfNumber", opts...)
	if err != nil {
		return nil, err
	}
